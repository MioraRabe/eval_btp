...
<html lang="en">
  ...
  <body>
    ...
    <section class="home-slider owl-carousel">
		<div class="slider-item" style="background-image: url(https://evalbtp-production.up.railway.app/clients_assets/images/btp1.jpg);" loading="lazy"></div>
								...
								<div class="menu-wrap">
									...
									<div class="text">
										...
										<p class="price">
											...
											<span>{{ $typemaison->duree }} jours</span></p>
